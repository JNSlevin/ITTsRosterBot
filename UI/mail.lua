...
function RB_NoteSettingsTest_OnInitialized( self )
    ...
    for i = 1, 5 do
        ...
        local control = CreateControlFromVirtual( 'RB_NoteSettingsTest_GuildTab' .. tostring( i ), self,
            'ITTsRosterBot_GuildTab' )
        local container = CreateControlFromVirtual( 'RB_NoteSettingsTest_GuildContainer' .. tostring( i ), self,
            'ITTRB_GuildSettings_ScrollContainer' )
        ...
        control:GetNamedChild( '_Button' ):SetHandler( "OnClicked", function( control )
            ...
            for section = 1, 5 do
                ...
                RB_NoteSettingsTest:GetNamedChild( '_GuildTab' .. tostring( section ) .. 'Name' ):SetColor( ZO_ColorDef:New( '333333' )
                    :UnpackRGBA() )
            ...
            RB_NoteSettingsTest:GetNamedChild( '_GuildTab' .. tostring( control._section ) .. 'Name' ):SetColor( ZO_ColorDef:
                New( 'FFFFFF' ):UnpackRGBA() )
